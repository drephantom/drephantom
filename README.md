<p align="center">
  <img src="assets/profile-header.svg" alt="drephantom — 记录、构建，慢慢理解。" width="100%">
</p>
...
[![Memory Garden 实际界面：使用示例笔记展示时间线与原文对照](https://raw.githubusercontent.com/drephantom/memory-garden/main/docs/images/timeline.png)](https://github.com/drephantom/memory-garden)
...
- **从问题到工具**：从自己的实际需求出发，把想法做成可以使用、持续改进的工具。

---

<sub>从具体的问题开始，让每一次构建留下可以回看的记录。</sub>
